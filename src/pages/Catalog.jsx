  ...
  useEffect(() => {
    const getCategories = async () => {
      try {
        ...
        const normalizedCatalogName = catalogName.toLowerCase().replace(/\s+/g, '-');
        const foundCategory = res.data.data.find((ct) => {
          const normalizedCategoryName = ct.name.toLowerCase().replace(/\s+/g, '-');
